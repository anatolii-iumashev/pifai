...
Пифэй - Проект про Психологию и Философию (База знаний на основе LLM + Чат бот на основе ИИ агентов).
...
GitHub: https://github.com/anatolii-iumashev/pifai
...
- [ ] Переименовать продукт в Пифия. Одно дело — знать путь, другое — пройти по нему.
- [ ] **Чат-бот в Telegram** — запуск первой версии бота ./docs/rfc/260515-bot.md
- [ ] Добавить раздел Психология для руководителей - про Адизеса, Тарасова, Макиавели и др.
